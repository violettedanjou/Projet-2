...
if ( ! function_exists( 'tourable_setup' ) ) :
	...
	function tourable_setup() {
		...
		add_theme_support( 'editor-color-palette', array(
	       	array(
				'name' => esc_html__( 'Sky Blue', 'tourable' ),
				'slug' => 'sky-blue',
				'color' => '#00bcd4',
	       	),
	       	array(
	           	'name' => esc_html__( 'Yellow', 'tourable' ),
	           	'slug' => 'yellow',
	           	'color' => '#ffbb44',
	       	),
	       	array(
	           	'name' => esc_html__( 'Black', 'tourable' ),
	           	'slug' => 'black',
	           	'color' => '#2a3235',
	       	),
	       	array(
	           	'name' => esc_html__( 'Grey', 'tourable' ),
	           	'slug' => 'grey',
	           	'color' => '#75939b',
	       	),
	   	));
		...
		add_theme_support( 'editor-font-sizes', array(
		   	array(
		       	'name' => esc_html__( 'small', 'tourable' ),
		       	'shortName' => esc_html__( 'S', 'tourable' ),
		       	'size' => 12,
		       	'slug' => 'small'
		   	),
		   	array(
		       	'name' => esc_html__( 'regular', 'tourable' ),
		       	'shortName' => esc_html__( 'M', 'tourable' ),
		       	'size' => 16,
		       	'slug' => 'regular'
		   	),
		   	array(
		       	'name' => esc_html__( 'larger', 'tourable' ),
		       	'shortName' => esc_html__( 'L', 'tourable' ),
		       	'size' => 36,
		       	'slug' => 'larger'
		   	),
		   	array(
		       	'name' => esc_html__( 'huge', 'tourable' ),
		       	'shortName' => esc_html__( 'XL', 'tourable' ),
		       	'size' => 48,
		       	'slug' => 'huge'
		   	)
		));
...
function tourable_scripts() {
	...
	// blocks
	wp_enqueue_style( 'tourable-blocks', get_template_directory_uri() . '/assets/css/blocks' . tourable_min() . '.css' );
 ...
 * @since Tourable 1.0.0
 */
function tourable_block_editor_styles() {
	// Block styles.
	wp_enqueue_style( 'tourable-block-editor-style', get_theme_file_uri( '/assets/css/editor-blocks' . tourable_min() . '.css' ) );
	// Add custom fonts.
	wp_enqueue_style( 'tourable-fonts', tourable_fonts_url(), array(), null );
}
add_action( 'enqueue_block_editor_assets', 'tourable_block_editor_styles' );
